...
@Getter
@NoArgsConstructor
public class RemitReqVo extends AbstractConvertVo {
    ...
    @Builder
    public RemitReqVo(HeaderVo headerVo, String accountNum, String accountName, String bankCode, String bankBranch, String remitAmt, String sendName, String filler1, String cmsCd, String filler2, String newBankCode, String filler3) {
